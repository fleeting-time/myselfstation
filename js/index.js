...
//     };
 ...
 // Welcome tomy website
    $(function(){
        ...
        we.animate({top:35,opacity:1},{duration:500}).animate({left:[-50,'easeOutQuint']},{duration:500}).animate({left:[30,'easeOutQuint']})
        ws.animate({bottom:35,opacity:1},{duration:500}).animate({right:[-50,'easeOutQuint']},{durattion:500}).animate({right:[30,'easeOutQuint']})
        //nav导航盒子
        var navBox=$('#navbox');
        ...
        $(window).scroll(function(){
            ...
            {
                oSLone.animate({left:0})
                oSLtwo.animate({top:0})
                oSRone.animate({right:0})
                oSRtwo.animate({bottom:0})
            }
        })
    })